...
use api::{
    resolve_startup_auth_source, ClawApiClient, AuthSource, ProviderClient, ContentBlockDelta,
...
fn open_browser(url: &str) -> io::Result<()> {
    ...
    {
        // Use rundll32 url.dll to open URLs properly in the default browser
        return match Command::new("rundll32")
